...
class vipxf extends AdminBase{
	...
	public final function vipxfLogDelete($id){
		...
		$sql="delete from Z4r5jk12_hytzjl_log where id=?";
	...
	public final function vipxiaofei(){
		$sql="select * from Z4r5jk12_hytzjlrule";
	...
	public final function setjj(){
		...
		$sql="update Z4r5jk12_hytzjlrule set money=$m,yi=$yi,er=$er,san=$san,si=$si,wu=$wu,liu=$liu,qi=$qi,ba=$ba,jiu=$jiu where id=1";
		...
		$sql="update Z4r5jk12_hytzjlrule set money=$m,yi=$yi,er=$er,san=$san,si=$si,wu=$wu,liu=$liu,qi=$qi,ba=$ba,jiu=$jiu where id=2";
		$this->exec($sql);
		...
		$sql="update Z4r5jk12_hytzjlrule set money=$m,yi=$yi,er=$er,san=$san,si=$si,wu=$wu,liu=$liu,qi=$qi,ba=$ba,jiu=$jiu where id=3";
		$this->exec($sql);
		...
		$sql="update Z4r5jk12_hytzjlrule set money=$m,yi=$yi,er=$er,san=$san,si=$si,wu=$wu,liu=$liu,qi=$qi,ba=$ba,jiu=$jiu where id=4";
		$this->exec($sql);
		...
		$sql="update Z4r5jk12_hytzjlrule set money=$m,yi=$yi,er=$er,san=$san,si=$si,wu=$wu,liu=$liu,qi=$qi,ba=$ba,jiu=$jiu where id=5";
		$this->exec($sql);
		...
		$sql="update Z4r5jk12_hytzjlrule set money=$m,yi=$yi,er=$er,san=$san,si=$si,wu=$wu,liu=$liu,qi=$qi,ba=$ba,jiu=$jiu where id=6";
		$this->exec($sql);
		...
		$sql="update Z4r5jk12_hytzjlrule set money=$m,yi=$yi,er=$er,san=$san,si=$si,wu=$wu,liu=$liu,qi=$qi,ba=$ba,jiu=$jiu where id=7";
		$this->exec($sql);
		echo "y";
		exit;
	}
