...
class System extends AdminBase{
	...
	public final function updateSettings(){
		...
		if(!ctype_digit($para['wxmin'])) throw new Exception('请正确设置支微信最高充值金额!');
		if(!ctype_digit($para['wxmax'])) throw new Exception('请正确设置支微信最高充值金额!');
		if(!ctype_digit($para['zfbsmmin'])) throw new Exception('请正确设置支付宝扫码最高充值金额!');
		if(!ctype_digit($para['zfbsmmax'])) throw new Exception('请正确设置支付宝扫码最高充值金额!');
		if(!ctype_digit($para['zfbzwymin'])) throw new Exception('请正确设置支付宝转网银最高充值金额!');
		if(!ctype_digit($para['zfbzwymax'])) throw new Exception('请正确设置支付宝转网银最高充值金额!');
