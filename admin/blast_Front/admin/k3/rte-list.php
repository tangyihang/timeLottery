...
// 默认查看玩法
// $chiTypes = $this->getRows("select a.playid,b.name from {$this->prename}k3 a left join {$this->prename}played b on b.id=a.playid group by a.playid,b.name order by a.playid");
// $groups   = $chiTypes;
...
$sql     = "select * from {$this->prename}k3 where playid=?";
	...
	<table class="tablesorter" cellspacing="0">
		...
		<?php foreach ($playeds as $played) {?>
			<tr>
				...
				<td><a href="/index.php/k3/updateLHCRte/<?=$played['id']?>" target="ajax" method="post" onajax="sysBeforeUpdatePlayed" call="reloadPlayed">保存修改</a></td>
			</tr>
		<?php }?>
		</tbody>
	</table>
