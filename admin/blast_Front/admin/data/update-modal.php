...
} else if ($para['type'] == 61 || $para['type'] == 62 || $para['type'] == 75 || $para['type'] == 76 || $para['type'] == 86) {//系统时时彩
    $actionNo = date('Ymd-', strtotime($para['actionTime'])) . substr($para['actionNo'] + 1000, 1);
...
<div>
    ...
    <form action="/index.php/data/updatedataed" target="ajax" method="post" call="dataSubmitCode"
          onajax="dataBeforeSubmitCode" dataType="html">
