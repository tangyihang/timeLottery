...
function win_change(){
	...
	if (win_type == "1"){
		...
		var t = "";
		for (i in list) {
			t += '<div style="cursor: pointer;margin-left:10px;float:left;text-align:center;width: 20px;height: 20px;border:0.5px solid red; border-radius: 10px;line-height: 20px;">'+
				list[i]+'</div>';
		}
