	...
	<table class="tablesorter left" cellspacing="0" width="100%">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<textarea name="tuijianfandian" cols="5" rows="1"><?=$this->settings['tuijianfandian']?></textarea><p>设置用户推广人返点比例1-10对应千分之一到百分之一</p>
				</td>
			</tr>
			<tr>
            ...
            <tr>
                <td>图片保存地址</td>
                <td>
                    <textarea name="imgURLServer" cols="56" rows="5"><?=$this->settings['imgURLServer']?></textarea>
                </td>
            </tr>
			...
			<tr>
				<td>签到奖励</td>
				<td>
					<input type="text" class="textWid1" value="<?=$this->settings['sign_num']?>" name="sign_num"/> 每天签到获取的奖励
				</td>
			</tr>
		</tbody>
	</table>
