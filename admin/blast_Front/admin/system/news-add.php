...
<header><h3 class="tabs_involved">添加新闻</h3></header>
<table>
<tr><td>
<form action="/index.php/system/doAddNews" method="post" target="ajax" call="sysReloadNews">
		<table class="tablesorter table2" cellspacing="0" width="100%">
			...
			<tr>
				<td></td>
				<td><input type="submit" class="alt_btn" value="添加新闻"/></td>
			</tr>
		</table>
	</form>
	</td>
