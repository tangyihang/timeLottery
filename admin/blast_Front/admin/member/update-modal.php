...
<div>
    ...
    <form action="/index.php/member/userUpdateed" target="ajax" method="post" call="userDataSubmitCode"
        ...
        <table cellpadding="2" cellspacing="2" class="popupModal">
            ...
            if ($bk) {
                ...
                <tr>
                    ...
                    <td><label><input type="radio" name="resetBank" value="1"/>重置</label> <label><input type="radio"
                                                                                                        name="resetBank"
                                                                                                        value=""
                                                                                                        checked/>不重置</label>
                    </td>
            ...
            <tr>
                ...
                <td><label><input type="radio" value="1"
                                ...
                                type="radio" value="0"
                                name="enable" <?php if (!$userData['enable']) echo 'checked="checked"' ?>/>冻结</label>
                </td>
            </tr>
            <tr>
                <td class="title" width="180">站内信开关：</td>
                <td><label><input type="radio" value="1"
                                  name="mLetterStatus" <?php if ($userData['mLetterStatus']) echo 'checked="checked"' ?>/>开</label>&nbsp;&nbsp;<label><input
                                type="radio" value="0"
                                name="mLetterStatus" <?php if (!$userData['mLetterStatus']) echo 'checked="checked"' ?>/>关</label>
                </td>
            </tr>
            <tr>
