...
<?php if($data['data']) foreach($data['data'] as $var){ ?>
    <tr>
        ...
        <td align="center">
            ...
            <a href="/index.php/bonus/bonusyjLogDelete/<?=$var['id']?>" target="ajax" call="bonusLogDelete" dataType="html">删除</a>
...
<footer>
<?php
		$rel=get_class($this).'/bonusYj-{page}?'.http_build_query($_GET,'','&');
