<?php
	...
	$sql="select uid,username,fanDian from Z4r5jk12_members WHERE (fanDian = 13.0 OR fanDian = 12.9)";
...
<article class="module width_full">
	...
	<tbody>
		<?php if($data) foreach($data as $var){ 
			...
			$bonusId = $this->getValue('select id from Z4r5jk12_bonus_log where uid='.$var['uid'].' and startTime='.$fromTime.' and endTime = '.$toTime);
			if($bonusId) continue;
