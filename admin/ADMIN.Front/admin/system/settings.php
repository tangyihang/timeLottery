		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<label><input type="radio" value="-900" name="LiRunLv" <?=$this->iff($this->settings['LiRunLv']==-900,'checked="checked"')?>/>随机盈利3%-60%</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp设置好后须重启开将器才能生效
				</td>
			</tr>
			<tr>
				<td>返点最大值</td>
			...
			<tr>
				...
				<td>
                    ...
                    <br />
					微信充值：最低金额 <input type="text" class="textWid1" value="<?=$this->settings['wxmin']?>" name="wxmin"/>元&nbsp;&nbsp;最高金额 <input type="text" class="textWid1" value="<?=$this->settings['wxmax']?>" name="wxmax"/>元&nbsp;&nbsp;
					<br />
					支付扫码付：最低金额 <input type="text" class="textWid1" value="<?=$this->settings['zfbsmmin']?>" name="zfbsmmin"/>元&nbsp;&nbsp;最高金额 <input type="text" class="textWid1" value="<?=$this->settings['zfbsmmax']?>" name="zfbsmmax"/>元&nbsp;&nbsp;
					<br />
					支付宝转网银：最低金额 <input type="text" class="textWid1" value="<?=$this->settings['zfbzwymin']?>" name="zfbzwymin"/>元&nbsp;&nbsp;最高金额 <input type="text" class="textWid1" value="<?=$this->settings['zfbzwymax']?>" name="zfbzwymax"/>元&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
				<td>提现限制</td>
