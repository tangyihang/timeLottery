<?php
	...
	$sqlAmount="select sum(b.mode * b.beiShu * b.actionNum) betAmount, sum(b.bonus) zjAmount, sum(b.fanDianAmount) fanDianAmount from Z4r5jk12_bets b where type={$this->type} and b.isDelete=0";
...
<input type="hidden" value="<?=$this->user['username']?>" />
	<header>
		...
		<form class="submit_link wz" action="/index.php/data/index/<?=$this->type?>" target="ajax" call="defaultSearch" dataType="html">
			...
			<label>日期：<input name="date" type="date" style="width:120px;" /></label>
