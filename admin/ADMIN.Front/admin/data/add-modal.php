...
if($para['type']==1){
...
}else if($para['type']==80){//分分彩
	$actionNo=date('YmdHi', strtotime($para['actionTime']));	
	...
	$actionNo = 179*(strtotime(date('Y-m-d', strtotime($para['actionTime'])))-strtotime('2007-11-11'))/3600/24+$para['actionNo']-3793;
