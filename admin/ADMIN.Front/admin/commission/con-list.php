<?php
	...
	//exit;
	$sql="select u.username, u.coin, u.uid, u.type, u.parentId, sum(b.mode * b.beiShu * b.actionNum) betAmount from Z4r5jk12_members u left join Z4r5jk12_bets b on u.uid=b.uid and b.isDelete=0 and b.actionTime between $fromTime and $toTime where 1 and u.parentId <> 0 and u.conCommStatus = 0 group by u.uid HAVING betAmount > ".floatval($this->settings['conCommissionBase1']);
