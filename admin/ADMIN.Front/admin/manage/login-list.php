<?php
	...
	$sql="select l.* from {$this->prename}sysadmin_session l, {$this->prename}sysmember u where admin=1 $timeWhere $userWhere $ipWhere and u.uid=l.uid order by loginTime desc";
	//echo $sql;exit;
    ...
    <header>
    	<h3 class="tabs_involved">登录日志
            <form action="/index.php/manage/loginLog" target="ajax" dataType="html" call="defaultSearch" class="submit_link wz">
                ...
                时间：从 <input type="date" class="alt_btn" style="width:120px;" name="fromTime"/> 到 <input type="date" class="alt_btn" style="width:120px;" name="toTime"/>&nbsp;&nbsp;
