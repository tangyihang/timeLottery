...
<input type="hidden" value="<?=$this->user['username']?>" />
	<header>
		...
		<form action="/index.php/manage/controlLogList" class="submit_link wz" target="ajax" dataType="html" onajax="adminLogBeforeSubmit" call="adminLogList">
			...
			时间：从<input type="date" class="alt_btn" style="width:120px;" name="fromTime" value="<?=date("Y-m-d",$this->time)?>"/> 到 <input type="date" class="alt_btn" style="width:120px;" name="toTime"/>&nbsp;&nbsp;
