...
(function(){
	...
	Main.prototype = {
		...
		onComplete : function(file) {
			fShowMessage("File:" + file.name + ", Size:" + file.size + " onComplete	[OK]"+"id = "+file.imgid);
			var data={id:file.imgid,name:file.name,size:file.size };
			 $.ajax({
			
        type: 'POST',
        url: '/index.php/system/updateimg',
        data: data,
        dataType: 'json',
        timeout: '30000',
		...
		uploadComplete : function(a) {
			...
			var info = {
				...
				totalPercent:       totalPercent,
				msg:                a.data,
				imgid :             this.config.imgid,
				url:                a.target.get("tokenURL")
			};
