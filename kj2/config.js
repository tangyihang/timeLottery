...
exports.cp = [
  ...
  //
	...
	// 			var num = $('.g_last .ml10').text();
	// 			var data_li = [];
	// 			$('.pk10_bg>ul>li').each(function(i, elem) {
	// 				data_li[i] = $(this).text();
	// 			});
	// 			var data_string = data_li.join(',');
  ...
  //
	...
	// 		try { //				/
	// 			var $ = cheerio.load(str);
	// 			var num_h = $('.kl8_bg').parents().attr('class','kl8css');
   //              var num = $(num_h).children('.ml10').text();
   //
	// 			var data_li = [];
	// 			$('.kl8_bg>ul>li').each(function(i, elem) {
	// 				data_li[i] = $(this).text();
	// 			});
	// 			var data_string = data_li.sort().join(',');
	// 			var myDate = new Date();
	// 			var year = myDate.getFullYear(); //年
	// 			var month = myDate.getMonth() + 1; //月
	// 			var day = myDate.getDate(); //日
