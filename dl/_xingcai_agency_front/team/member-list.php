            ...
            <div class="columns columns-right btn-group pull-right">
                ...
                <div class="keep-open btn-group" title="列">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <label>
                                <input type="checkbox" data-field="lastLoginDatetime" value="6" checked="checked">
                                最后登录时间
                            </label>
                        </li>
                        <li>
            ...
            <div class="fixed-table-body">
                ...
                <table id="datagrid_tb" class="table table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <th style="text-align: center; vertical-align: middle; " data-field="lastLoginDatetime"
                            tabindex="0">
                            <div class="th-inner sortable both">
                                最后登录时间
                            </div>
                        ...
                        <th style="text-align: center; vertical-align: middle; " data-field="accountStatus"
                            tabindex="0">
                            <div class="th-inner ">
                                状态
                            </div>
                        ...
                        <th style="text-align: center; vertical-align: middle; width: 200px; " data-field="10"
                            tabindex="0">
                            <div class="th-inner ">
                                操作
                            </div>
...
<div class="modal fade bs-example-modal-lg" id="editmodel" tabindex="-1" role="dialog" aria-labelledby="editLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered table-striped" style="clear: both">
                    ...
                    <tr>
                        ...
                        <td width="35%" class="text-left"><input type="text" class="form-control" id="account"
                    ...
                    <tr class="userinfo_tr">
                        ...
                        <td width="35%" class="text-left"><input type="text" class="form-control" id="userName"
                                                                 disabled="disabled"></td>
                    </tr>
                    <tr class="userinfo_tr">
                        <td width="15%" class="text-right">银行账号：</td>
                        <td width="35%" class="text-left"><input type="text" class="form-control" id="cardNo"
                                                                 disabled="disabled">
                        </td>
                    ...
                    <tr class="rebateNum_tr">
                        ...
                        <td width="35%" class="text-left multiData hidden"><input type="text" class="form-control"
                                                                                  id="rebateNum"></td>
                        <td width="50%" class="text-left multiData hidden" colspan="2"><span id="rebate_desc"></span>
                        </td>
                    </tr>
                    <tr class="userinfo_tr">
                        <td width="15%" class="text-right showTel">电话：</td>
                        <td width="35%" class="text-left showTel"><input type="text" class="form-control" id="phone"
                                                                         disabled="disabled"></td>
                        <td width="15%" class="text-right showEmail">邮箱：</td>
                        <td width="35%" class="text-left showEmail"><input type="text" class="form-control" id="email"
                                                                           disabled="disabled"></td>
                    </tr>
                    <tr class="parentNames_tr">
                        <td width="15%" class="text-right showBankAdd">银行地址：</td>
                        <td width="35%" class="text-left showBankAdd"><input type="text" class="form-control"
                                                                             id="bankAddress" disabled="disabled"></td>
                        <td width="15%" class="text-right showQQ">QQ：</td>
                        <td width="35%" class="text-left showQQ"><input type="text" class="form-control" id="qq"
                                                                        disabled="disabled"></td>
                    </tr>
                    <tr>
                        <td width="15%" class="text-right">所属上级：</td>
                        <td width="85%" colspan="3" class="text-left"><textarea class="form-control" id="parentNames"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="save();" id="save_btn">保存
                </button>
...
<!-- 增加下级 -->
<div class="modal fade bs-example-modal-lg" id="editmodel2" tabindex="-1" role="dialog" aria-labelledby="editLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body hidden" id="memmnyope_tb">
                <table class="table table-bordered" style="margin-top:10px;clear: both">
                    ...
                    <tr>
                        ...
                        <td width="65%" colspan="2"><select id="type" class="form-control">
                    ...
                    <tr>
                        <td colspan="3" class="text-center">
                            <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="submit1();">确认
                            </button>
                        </td>
                    </tr>
                    </tbody>
...
<div class="modal fade bs-example-modal-lg" id="editmodel3" tabindex="-1" role="dialog" aria-labelledby="editLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <table class="table table-bordered" style="margin-top: 10px; clear: both">
                    ...
                    <tr>
                        ...
                        <td width="65%" colspan="2"><input type="text" class="form-control"
                                                           style="width: 25%; float: left;" id="fsAdd"> <span
                                    style="line-height: 32px;">(可设置返点区间: <span class="lable lable-success"><span
                                            id="fsCur2"></span>-<span class="cfands">0.4</span></span>)
								</span></td>
                    </tr>
                    <tr>
                        <td width="35%" class="text-right">所属上级：</td>
                        <td width="65%" colspan="3" class="text-left"><textarea class="form-control" id="parentNames2"
                                                                                disabled="disabled"></textarea></td>
                    </tr>
                    </tbody>
                </table>
...
<script id="memmnyope_tpl" type="text/html">
    <table class="table table-bordered" style="margin-top:10px;clear: both">
        ...
        <tr>
            <td colspan="3" class="text-center">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="submit1();">确认</button>
            </td>
        </tr>
        </tbody>
    </table>
