        ...
        <div class="fixed-table-toolbar">
                    ...
                    <div class="form-group">
                        <div class="form-inline">
                            <div class="input-group">
                                <input type="text" class="form-control" id="begin" value="2018-01-01 00:00:00"
                                       placeholder="开始日期"/>
                        ...
                        <div class="form-inline" style="margin-top: 5px;">
                            <div class="input-group">
                                <input type="text" id="end" class="form-control" value="2019-12-30 23:59:59"
                                       placeholder="线束日期"/>
                                <span class="glyphicon glyphicon-th form-control-feedback" aria-hidden="true"></span>
                            </div>
            ...
            <div class="columns columns-right btn-group pull-right">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><label><input type="checkbox" data-field="account" value="0" checked="checked"/> 会员账号</label>
                    </li>
                    <li><label><input type="checkbox" data-field="type" value="1" checked="checked"/> 变动类型</label></li>
                    <li><label><input type="checkbox" data-field="beforeMoney" value="2" checked="checked"/>
                            变动前金额</label></li>
                    <li><label><input type="checkbox" data-field="money" value="3" checked="checked"/> 变动金额</label></li>
                    <li><label><input type="checkbox" data-field="afterMoney" value="4" checked="checked"/>
                            变动后余额</label></li>
                    <li><label><input type="checkbox" data-field="createDatetime" value="5" checked="checked"/> 变动时间(系统)</label>
                    </li>
