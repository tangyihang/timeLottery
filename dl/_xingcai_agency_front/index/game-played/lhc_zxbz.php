...
<div class="dGameStatus lotteryView_lhc4">
		...
		<dd>
		<span id="RteNOHIT5" class="sGameStatusItem">五不中</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteNOHIT5',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input type="radio" value="NOHIT5" name="txtGameItem" rel="5" pri="<?=$this->getLHCRte('RteNOHIT5',$this->played)?>" maxlen="500" class="inputnoborder"></span>
		</dd>
		<dd>
		<span class="sGameStatusItem">六不中</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteNOHIT6',$this->played)?></span>
		...
		<dd>
		<span class="sGameStatusItem">七不中</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteNOHIT7',$this->played)?></span>
		...
		<dd>
		<span class="sGameStatusItem">八不中</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteNOHIT8',$this->played)?></span>
		...
		<dd>
		<span id="LOTTOTBSOED" class="sGameStatusItem">九不中</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteNOHIT9',$this->played)?></span>
		...
		<dd>
		<span class="sGameStatusItem">十不中</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteNOHIT10',$this->played)?></span>
		...
		<dd>
		<span id="LOTTOTBSOEO" class="sGameStatusItem">十一不中</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteNOHIT11',$this->played)?></span>
