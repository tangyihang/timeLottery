...
<input type="hidden" name="type" value="<?=$this->type?>" />
	...
	<div class="dGameStatus hklhc lotteryView_sxtw" action="tzlhcSelect" length="1">
		...
		<dd>
		<span class="sGameStatusItem">二尾碰</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteSNSD2',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input style="margin-left:28px;" type="radio" value="SNSD2" name="txtGameItem" rel="2" pri="<?=$this->getLHCRte('RteSNSD2',$this->played)?>" class="inputnoborder"></span>
		</dd>
		</dl>
			<dl>
		<dt>
		...
		<dd>
		<span class="sGameStatusItem">三尾碰</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteSNSD3',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input style="margin-left:28px;" type="radio" value="SNSD3" name="txtGameItem" rel="3" pri="<?=$this->getLHCRte('RteSNSD3',$this->played)?>" class="inputnoborder"></span>
		</dd>
			</dl>
			<dl>
		<dt>
		...
		<dd>
		<span id="LOTTOTBSOED" class="sGameStatusItem">四尾碰</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteSNSD4',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input style="margin-left:28px;" type="radio" value="SNSD4" name="txtGameItem" rel="4" pri="<?=$this->getLHCRte('RteSNSD4',$this->played)?>" class="inputnoborder"></span>
		</dd>
			</dl>
			<dl>
		<dt>
		...
		<dd>
		<span id="LOTTOTBSOEO" class="sGameStatusItem">五尾碰</span><span class="num" style="margin-left:12px;"><?=$this->getLHCRte('RteSNSD5',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input style="margin-left:28px;" type="radio" value="SNSD5" name="txtGameItem" rel="5" pri="<?=$this->getLHCRte('RteSNSD5',$this->played)?>" class="inputnoborder"></span>
		</dd>
			</dl>
