...
<div class="dGameStatus hklhc lotteryView_lhc3" action="tzlhcSelect" length="1">
		...
		<dd>
		<span id="RteSPBSOED" class="sGameStatusItem">四全中</span><span class="num" style="margin-left:-5px;margin-top: -3px;"><?=$this->getLHCRte('RteLM4OF4',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input type="radio" value="LM4OF4" rel="4" pri="<?=$this->getLHCRte('RteLM4OF4',$this->played)?>" name="txtGameItem" class="inputnoborder"></span>
		</dd>
		</dl>
			<dl>
		<dt>
		...
		<dd>
		<span class="sGameStatusItem">三全中</span><span class="num" style="margin-left:-5px;margin-top:-3px;"><?=$this->getLHCRte('RteLM3OF3',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input type="radio" value="LM3OF3" rel="3" pri="<?=$this->getLHCRte('RteLM3OF3',$this->played)?>" name="txtGameItem" class="inputnoborder"></span>
		</dd>
			</dl>
			<dl>
		<dt>
		...
		<dd>
		<span class="sGameStatusItem">三中二</span><span class="num" style="margin-left:-6px;margin-top: -3px;"><?=$this->getLHCRte('RteLM2OF31',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input type="radio" value="LM2OF3" rel="3" pri="<?=$this->getLHCRte('RteLM2OF31',$this->played)?>" name="txtGameItem" class="inputnoborder"></span>
		</dd>
			</dl>
			<dl>
		<dt>
		...
		<dd>
		<span class="sGameStatusItem">二中二</span><span class="num" style="margin-left:-6px;margin-top:-3px;"><?=$this->getLHCRte('RteLMSPOF21',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input type="radio" value="LM2OF2" rel="2" pri="<?=$this->getLHCRte('RteLM2OF2',$this->played)?>" name="txtGameItem" class="inputnoborder"></span>
		</dd>
			</dl>
			<dl>
		<dt>
		...
		<dd>
		<span class="sGameStatusItem">二中特</span><span class="num" style="margin-left:-6px;margin-top:-3px;"><?=$this->getLHCRte('RteLM2OF2',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input type="radio" value="LMSPOF2" rel="2" pri="<?=$this->getLHCRte('RteLMSPOF21',$this->played)?>" name="txtGameItem" class="inputnoborder"></span>
		</dd>
			</dl>	
			<dl>
		<dt>
		...
		<dd>
		<span class="sGameStatusItem">特串</span><span class="num" style="margin-left:8px;margin-top:-3px;"><?=$this->getLHCRte('RteLMSPOF',$this->played)?></span>
		<span class="input" style="margin-left:-3px;"><input type="radio" value="LMSPOF" name="txtGameItem" rel="1" pri="<?=$this->getLHCRte('RteLMSPOF',$this->played)?>" class="inputnoborder"></span>
		</dd>
			</dl>			
			</div></div></div>
