        ...
        <div id="subContent_bet_re">
            <div class="activity_content">
                ...
                <div class="activity_banner"
                     style="background:url(/images/nsc/activity/activity_banner02.jpg) no-repeat center top;"></div>
                <div class="activity_title">
                    ...
                    ?>
                    <p class="counyongjin">今日已充值<span
                                id="days"><?= $this->iff($rechargeAmount, $rechargeAmount, 0) ?></span>元</p>
                    <?php
                    if (!$ret) { ?>
                        <a href="#"
                           onclick="hdSign(<?= $item['id'] ?>,<?= $this->user['uid'] ?>,'chose_<?= $item["id"] ?>')"
                           class="check_btn">领取充值任务</a>
                    <?php } else {
                        ?>
                        <a href="#"
                           onclick="hdGet(<?= $item['id'] ?>,<?= $this->user['uid'] ?>,'chose_<?= $item["id"] ?>')"
                           class="check_btn">领取充值福利</a>
                    <?php } ?>
                </div>
...
TIP;
                    ...
                    <div class="x-text"><p>
                        <p></p>
                        <p></p>
                        <p>1、当天首次充值满足活动要求，且当天消费达到流水要求即可领取对应的活动奖金。</p>
                        <p>2、用户打开官网活动公告中的“热门活动”，点击“充值福利”页面上的“领取充值福利”即可完成奖金领取。</p>
                        <p>3、奖金需在当天(23:59:59之前)完成领取，隔天无效。</p>
                        <p>4、用户自身领取奖金后出款，要求满足对应奖金的流水要求。</p>
                        <p>5、本次活动计算彩票投注，可与其他活动共享。</p>
                        <p>6、同一账户、同一银行卡、同一IP每天只可参加一次活动。</p>
                        <p>
                            7、任何的无风险投注，对冲，对打均不计算有效投注。有效投注定义：玩法投注不得超过该玩法投注最大注数的70%，即定位胆不得超过7注，二星不得超过70注，三星不得超过700注，四星不得超过7000注，五星不得超过70000注。如发现利用活动存在对冲等恶意套利行为，杏彩有权扣除违规所得。</p>
                        <p>8、【喜洋洋彩】有权对活动随时做出更改、终止，并享有最终解释权。</p>
                        <p></p>
                        <p></p>
                        <p></p>
                        <p></p>
