...
exports.k3hz = function (bet, kj) {
  ...
  var count = 0;
  for (var i = 0; i < bet.length; i++) {
    if (bet[i].indexOf('大') != -1 && val > 10) {
      count += 1;
    } else if (bet[i].indexOf('小') != -1 && val <= 10) {
      count += 1;
    } else if (bet[i].indexOf('双') != -1 && val % 2 == 0) {
      count += 1;
    } else if (bet[i].indexOf('单') != -1 && val % 2 == 1) {
      count += 1;
    } else if (parseInt(bet[i]) == val) {
      count += 1;
    }
  }
  return count;
