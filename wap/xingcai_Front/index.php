...
<body>
    ...
    <div id="wrapper_1" class="scorllmain-content top_bar bottom_bar">
        <div class="sub_ScorllCont">
            <div class="header-banner" style="height: 160px; overflow: hidden;">
                <a href="/index.php/index/activity"><img class="banner" style="width: 100%;height:157px; display: block;" src="/assets/statics/img/top1.jpg"></a>
                <a href="/index.php/index/activity_info?id=2"><img class="banner" style="width: 100%;height:157px; display: none;" src="/assets/statics/img/top2.jpg"></a>
                <a href="/index.php/index/activity_info?id=1"><img class="banner" style="width: 100%;height:157px; display: none;" src="/assets/statics/img/top3.jpg"></a>
                <a href="/index.php/index/activity_info?id=5"><img class="banner" style="width: 100%;height:157px; display: none;" src="/assets/statics/img/top4.jpg"></a>
            </div>
            ...
            <div class="index-menu">
                <ul>
                    <li>
                        <a href="/safe/Personal"><img src="assets/statics/img/menu1.png"><p>存款充值</p></a>
                    </li>
                    <li>
                        <a href="/index.php/index/mfsw"><img src="assets/statics/img/menu3.png"><p>免费试玩</p></a>
                    </li>
                    <li>
                        <a href="/index.php/index/activity"><img src="assets/statics/img/menu2.png"><p>优惠活动</p></a>
                    </li>
                    <li>
                        <a href="http://www.365webcall.com/chat/mobileChatWin.aspx?h=&settings=mw7mbXbm7Pm6Xmz3APImIXz3AwwNPz3A66mmP6&LL=0&chs=&ClientID=9c62e07c-b480-4ede-be71-cbfd538a9c67&loc" target="_blank"><img src="assets/statics/img/menu4.png"><p>在线客服</p></a>
                    </li>
                </ul>
            </div>
            <div style="clear:both;"></div>
            <div class="hot-tit "><a href="javascript:;"><i style="color: #ec0909;margin-right: 5px;font-size: 1rem;" class="ion-ios-flame"></i>热门彩种</a></div>
            <div class="hot-lot">
                <ul>
                    <li>
                        <a href="/index.php/index/game/86">
                            <div class="hot-icon icon_idx_0"><img class="" src="assets/statics/images/icon/51.png"></div>
                            <div class="hot-text text_idx_0"><span>三分时时彩</span><p>3分钟一期</p></div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/index.php/index/game/1/2/12">
                            ...
                            <div class="hot-text text_idx_0"><span>重庆时时彩</span><p>5分钟一期</p></div>
                    ...
                    <li>
                        <a href="/index.php/index/game/20">
                            ...
                            <div class="hot-text text_idx_0"><span>北京赛车(PK10)</span><p>5分钟一期</p></div>
                    ...
                    <li>
                        <a href="/index.php/index/game/83">
                            ...
                            <div class="hot-text text_idx_0"><span>北京28</span><p>10分钟一期</p></div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/index.php/index/game/34">
                            ...
                            <div class="hot-text text_idx_0"><span>香港⑥合彩</span><p>每周开奖3期</p></div>
                        </a>
                    </li>
                    <!--
                    <li>
	...
	<div class="menu">
	      <ul>
             <li>
                <a class="menu-home" style="color: #ec0909;" href="/"><i class="ion-ios-home"></i><p>首页</p></a>
             </li>
                           <li>
