...
<div class="dGameStatus hklhc lotteryView_lhc" action="tzlhcSelect" length="1">
		...
		<span class="red">46</span><span class="num" data-id="RteLO46"><?=$this->getLHCRte('RteLO46',$this->played)?></span>
		...
		<span>号码</span><span style="width:76px;">赔率</span><span style="width:28px;">金额</span>
				...
				<dd >
				<span class="sGameStatusItem">总大</span><span class="num" style="margin-left:12px;" data-id="RteLTTBSOED"><?=$this->getLHCRte('RteLTTBSOED',$this->played)?></span>
				<span class="input" ><input maxlength="5" id="RteLTTBSOED" name="LTTBSOE" acno="总大" type="text"></span>
				</dd>
				<dd>
				<span class="sGameStatusItem">总小</span><span class="num" style="margin-left:12px;" data-id="RteLTTBSOES"><?=$this->getLHCRte('RteLTTBSOES',$this->played)?></span>
				<span class="input" ><input maxlength="5" id="RteLTTBSOES" name="LTTBSOE" acno="总小" type="text"></span>
				</dd>
				<dd>
				<span id="LOTTOTBSOED" class="sGameStatusItem">总单</span><span class="num" style="margin-left:12px;" data-id="RteLTTBSOEO"><?=$this->getLHCRte('RteLTTBSOEO',$this->played)?></span>
				<span class="input" ><input maxlength="5" id="RteLTTBSOEO" name="LTTBSOE" acno="总单" type="text"></span>
				</dd>
				<dd>
				<span id="LOTTOTBSOEO" class="sGameStatusItem">总双</span><span class="num" style="margin-left:12px;" data-id="RteLTTBSOEE"><?=$this->getLHCRte('RteLTTBSOEE',$this->played)?></span>
				<span class="input" ><input maxlength="5" id="RteLTTBSOEE" name="LTTBSOE" acno="总双" type="text"></span>
				</dd>
		</dl>
			<dl>
		<dt>
