                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" id="playList">
						...
						<?php if($list['data']) foreach($list['data'] as $var){ ?>
                                <tr class="gradeX" tourl="/index.php/box/senddetail/<?=$var['mid']?>" dataid="<?=$var['mid']?>"  >
								...
								<td><a  class="pull-right btn btn-xs btn-primary" data-toggle="modal" data-target="#myModal6" href="/index.php/box/senddetail/<?=$var['mid']?>">查看</a></td>
