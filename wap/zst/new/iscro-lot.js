...
//检测登陆
function checkLogin(currentUrl,referrerUrl) {
    $.ajax({
        ...
        success: function (data) {
            if (data.isLogin == false) {
                ...
                if(currentUrl.indexOf("/mine/msgDetail.html") > -1){
                    window.location.href = '/mine/message.html';
                    return;
                }
                if(currentUrl.indexOf("/mine/message.html") > -1){
                    window.location.href = '/mine/index.html';
                    return;
                }
                if (currentUrl.indexOf("/betSix/index.html") > -1) {
                    window.history.go(-1);
                    return;
                }
                //
                if(currentUrl.indexOf("/mine/betList.html") == -1
                    && referrerUrl.indexOf("/mine/betDetail.html") > -1) {
                    sessionStorage.backFromBet = 1;
                    return;
                }
                window.history.go(-1);
            }
