...
<table class="layui-table">
    ...
    <tr>
        <td>
            <span style="color: #F00;"><?= $this->iff($bet['username'] == $this->user['username'], $bet['username'], preg_replace('/^(\w).*(\w{2})$/', '\1***\2', $bet['username'])) ?></span>
        </td>
...
<table class="layui-table">
    ...
    <tr>
        <td>
            <span style="color: #F00;"><?= $this->iff($bet['lotteryNo'], number_format($bet['bonus'] - $betCont + ($bet['fanDian'] / 100) * $betCont, 3), '－') ?></span>
        </td>
        <td><span style="color: #F00;"><?= number_format($betCont, 3) ?></span></td>
        <td>
            <span style="color: #F00;"><?= $this->iff($bet['lotteryNo'], number_format($bet['bonus'], 3) . '元', '－') ?></span>
        </td>
...
<table class="layui-table">
    ...
    <tbody>
    <tr>
        <td style="position:inherit; overflow:auto;word-wrap:break-word;word-break:break-all;"><span
                    style="color: #828282;font-size: 21px;"><?= $wei . $bet['actionData'] ?></span></td>
    </tr>
    </tbody>
</table>  
