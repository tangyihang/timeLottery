...
<div class="zc_cont">
    <div class="zc_content">
        ...
        <div class="zc_list" id="apDiv4">
            <ul id="reg_con">
                <?php if ($args[0]) { ?>
                    <form action="/index.php/user/rog" onkeydown="if(event.keyCode==13){return false;}" method="post"
                          onajax="registerBeforSubmit" enter="true" call="registerSubmit" target="ajax">
                        <input type="hidden" name="codec" value="<?= $args[0] ?>"/>
                        <li>
                            <label class="zc_label">登录帐号</label>
                            <div class="zc_input"><i class="iczc-number"></i>
                                <input type="text" name="username" id="username" class="forget_input"
                                       placeholder="请输入帐号" onKeyUp="value=value.replace(/[\W]/g,'')" maxLength=15/>
                        ...
                        <li>
                            ...
                            <div class="zc_input"><i class="iczc-password"></i>
                                <input id="epwd" type="password" name="password" id="password" class="forget_input"
                                       placeholder="请输入密码" onKeyUp="value=value.replace(/[\W]/g,'')" maxLength=13>
                        ...
                        <li>
                            ...
                            <div class="zc_input"><i class="iczc-password"></i>
                                <input id="checkpwd" type="password" name="cpasswd" id="cpasswd" class="forget_input"
                                       placeholder="请确认密码" onKeyUp="value=value.replace(/[\W]/g,'')" maxLength=13>
                        ...
                        <li>
                            ...
                            <div class="zc_input"><i class="iczc-password"></i>
                                <input type="text" name="qq" id="qq" class="forget_input"
                                       onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9]/,'');}).call(this)"
                                       maxLength=11 placeholder="请输入QQ号码">
                        ...
                        <li>
                            ...
                            <div class="zc_input"><i class="iczc-warning"></i>
                                <input type="text" name="vcode" id="vcode" class="forget_input" style="width:150px;"
                                       placeholder="请输入验证码" maxLength=4
                                       onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9]/,'');}).call(this)"
                                       onblur="this.v();">
                                <img onclick="this.src='/index.php/user/vcode/'+(new Date()).getTime()" title="点击刷新"
                                     style="cursor:pointer; border: 0px solid #999; vertical-align:middle;"
                                     src="/index.php/user/vcode/<?= $this->time ?>" class="zc_code">
                                <p></p>
                                <div class="tip"><em></em>
                                    <p></p></div>
                            </div>
