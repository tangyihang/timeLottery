...
<head>
    ...
    <!--[if lte IE 8]>
    <style>.ie-alert-bg, .ie-alert-wrap {
    ...
    <script type="text/javascript">function zxkf() {
        <?php if ($this->settings['kefuStatus']) {?>layer.open({
          type: 2,
          area: ['800px', '550px'],
          zIndex: 1999,
          //fixed: false, //不固定
        ...
        <div class="quick-tpis">
            ...
            <div class="header-right fr">
                ...
                <ul class="header-top-right fr ">
                    ...
                    <li><a id="agent_reg_url" class="right-border" href="http://dl.222345678.com">代理登陆</a></li>
                    ...
                    <li id="wdtg"><a class="right-border " href="#"
                                    ...
                                    src="/assets/statics/images/hot_new.gif"></a></li>
                        ...
                        <div class="top_login">
                            <div style="float:right;">
                                <div style="float: left;">
                                    <div class="top-login-bg"><i class="icon-6"></i><input class="top_loginip"
                                                                                           name="username" type="text"
                                                                                           id="username"
                                                                                           placeholder="请输入用户名"></div>
                                    <div class="top-login-bg"><i class="icon-lock-icon"></i><input class="top_loginip"
                                                                                                   name="passwd"
                                                                                                   id="password"
                                                                                                   type="password"
                                                                                                   placeholder="请输入密码">
                                    ...
                                    <div class="need_captcha">
                                        ...
                                        <div class="yanzhengma">
                                            <div class="top-login-bg2">
                                                <input class="top_loginmm" id="authnum" name="authnum" maxlength="4"
                                                       type="text" placeholder="">
                                                <span class="register_captcha_span"
                                                      style="margin:0; position: relative;">
	                                                            <img name="login_img" class="login_img"
                                                                     style="margin-top:4px"
                                                                     src="/index.php/user/vcode/1498379763" title="点击刷新"
                                                                     onClick="this.src='/index.php/user/vcode/'+(new Date()).getTime()">
                                ...
                                <div style="float: left;margin-top: 1px">
                                    <input style="margin-right: 14px;" class="dr_anniu" onClick="index_userLogin();"
                                           type="button" name="login" value="登录">
                                    <input class="dr_anniu reg_anniu" type="button"
                                           onClick="__openWin('login','/index.php/user/login')" value="注册">
                                </div>
                            </div>
                    ...
                    <div class="top_login">
                        ...
                        <span>&nbsp;|&nbsp;
                                    ...
                                    <a style="display:none;"
                                       onClick="__openWin('user_center','/index.php/safe/tuiguang');">我的推广</a>
        ...
        <div class="header-navbar-plus">
            <div class="wrapper clearfix" id="header_box">
                <div class="lottery-plus" id="lotterys">
                    ...
                    <div class="lotterys-list-hd lotterys-list-hd-border1" id="lotterysList" style="display:block">
                        <ul class="lottery-list-box" id="lottery-list-box">
                            <li class="mainGame">
                                <a onClick="" class="mainA">
                                    <i class="icon nav40-9">
                                        <img src="./images/nsc/warp/icon/am_ks.png"></i>
                                </a>
                                <div class="fl">
                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/63/39/澳门快三');"
                                       class="mainA">
                                        <span class="color333">澳门快三</span>
                                        <p onClick="__openWin('lottery_hall','/index.php/index/game/63/39/澳门快三');"
                                           target="_blank" class="status-desc"></p>
                                    </a>
                                </div>
                            </li>
                            <li class="mainGame">
                                ...
                                <div class="fl">
                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/86/2/12/三分时时彩');"
                                       class="mainA">
                                        <span class="color333">三分时时彩</span>
                                        <p onClick="__openWin('lottery_hall','/index.php/index/game/86/2/12/三分时时彩');"
                                           target="_blank" class="status-desc"></p>
                                    </a>
                                </div>
                            </li>
                            <li class="mainGame">
                                <a onClick="__openWin('lottery_hall','/index.php/index/game/1/2/12/重庆时时彩');"
                                   class="mainA">
                                    <i class="icon nav40-9">
                                ...
                                <div class="fl">
                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/1/2/12/重庆时时彩');"
                                       class="mainA">
                                        ...
                                        <p onClick="__openWin('lottery_hall','/index.php/index/game/1/2/12/重庆时时彩');"
                                           target="_blank" class="status-desc">最火爆的快彩</p></a>
                                </div>
                            </li>
                            <li class="mainGame">
                                <a onClick="__openWin('lottery_hall','/index.php/index/game/20/27/北京PK拾');"
                                   class="mainA">
                                    <i class="icon nav40-9">
                            ...
                            <!-- <li class="mainGame">
                                ...
                                <div class="fl">
                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/34/香港⑥合彩');"
                                       class="mainA">
                            ...
                            <li class="allGames clearfix" data-type="1">
                                ...
                                <ul class="clearfix game-list">
                                    <li>
                                        <a onClick="__openWin('lottery_hall','/index.php/index/game/63/39/澳门快三');">澳门快三</a>
                                    </li>
                                    <li>
                                        <a onClick="__openWin('lottery_hall','/index.php/index/game/86/2/12/三分时时彩');">三分时时彩</a>
                                    </li>
                                    <li>
                                        <a onClick="__openWin('lottery_hall','/index.php/index/game/1/2/12/重庆时时彩');">重庆时时彩</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="moreGames-box fl">
                                        <div class="otherGames num-games">
                                            ...
                                            <ol>
                                                ...
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/79/39/江苏快三');">江苏快三</a>
                                                </li>
                                ...
                                <div class="moreGames clearfix" style="display: none;" id="moreGames_3">
                                    <div class="moreGames-box fl">
                                        <div class="otherGames num-games">
                                            ...
                                            <ol>
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/game/63/39/澳门快三');">澳门快三</a>
                                                </li>
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/86/2/12/三分时时彩');">三分时时彩</a>
                                                </li>
            ...
            <div class="slide">
                <div id="slides">
                    <div class="slides_container">
                        <div class="slides_container banner has-dots" id="b04"
                             style="overflow: hidden; width: 764px; height: 288px;">
                            <ul style="width: 400%; position: relative;  height: 288px; overflow: hidden;">
                                <li class="show_picture" id="show_pic_0" style="width: 25%;">
                                    <img src="./files/1.jpg" class="sliderimg" width="764px" height="288px">
                                </li>
                                <li class="show_picture" id="show_pic_1" style="width: 25%;">
                                    <img src="./files/2.jpg" class="sliderimg" width="764px" height="288px">
                                </li>
                                <li class="show_picture" id="show_pic_2" style="width: 25%;">
                                    <img src="./files/3.jpg" class="sliderimg" width="764px" height="288px">
                                </li>
                                <li class="show_picture" id="show_pic_3" style="width: 25%;">
                                    <img src="./files/4.jpg" class="sliderimg" width="764px" height="288px">
                                </li>
                            </ul>
                            <ol class="dots">
                                <li class="dot">1</li>
                        ...
                        <div class="quick-buy-box">
                            ...
                            <div name="content" class="qb qb-box-list" id="_index_countdownIssue">
                                <ul name="quick_tab_list" class="quick-tab-list">
                                    <li class="tab-sel-open on" data-gameid="63" name="gameid_63"><a>澳门快三</a></li>
                                ...
                                <div class="qb-tz-box clearfix">
                                    <div class="fl bei-box clearfix">
                                        ...
                                        <input name="times_nums" type="text" maxlength="3" data-type="fc3d"
                                               id="times_nums" onBlur="setTimesNum(0)" class="multiple" value="1">
                                        <a onClick="setTimesNum(2)" class="tz_bei_add" data-type="fc3d">+</a>
                                        <span class="mr10">倍</span> 共 <strong name="bet_amount" id="bet_amount"
                                                                              class="money time-color">2</strong> 元
                                    </div>
                                    <div class="dg-btn-box">
                                        <a name="change_gameNum" class="change-btn" id="fc3d_random">
                                            <i class="icon-refresh-icon"></i> 换一注
                                        </a>
                                        <a name="doBet" onClick="rightNow()" class="dg-tz-btn icon"
                                           id="fc3d_submit_index">立即投注</a>
                                    </div>
                                </div>
                            ...
                            <div class="help-tab-box">
                                <ul class="help-tab">
                                    <li id="help_tab_hot" class="on" onMouseOver="setHelpTab(this, 'hot')"><a
                                                class="web-notice">网站公告</a></li>
                                    <li id="help_tab_newer" onMouseOver="setHelpTab(this, 'newer')" class=""><a
                                                class="user-help">新手指导</a></li>
                                </ul>
    ...
    <div class="foot_box">
        <div class="about_box">
            <p>2018-2028©<span>喜羊羊彩 | </span> 客服邮箱：1163408818@qq.com 客服QQ：1163408818
                <br><span class="c-grey">喜洋洋彩郑重提示：彩票有风险，投注需谨慎！ 不向未满18周岁的青少年出售彩票</span></p>
            <!--<ul class="foot_info">
...
<div class="ie-alert-wrap" style="display: none;">
    ...
    <p>自 2016 年 1 月 12 日起，Microsoft 不再为 IE 11 以下版本提供相应支持和更新。没有关键的浏览器安全更新，您的 PC
        可能易受有害病毒、间谍软件和其他恶意软件的攻击，它们可以窃取或损害您的业务数据和信息。请参阅 <a
                href="https://www.microsoft.com/zh-cn/WindowsForBusiness/End-of-IE-support">微软对 Internet Explorer
            早期版本的支持将于 2016 年 1 月 12 日结束的说明</a> 。</p>
    <hr>
    <h2>更先进的浏览器</h2>
    ...
    <ul class="browser">
        <li class="browser-chrome"><a href="http://www.google.cn/chrome/browser/index.html?hl=zh-CN&amp;standalone=1"
                                      target="_blank"> 谷歌浏览器<span>Google Chrome</span></a></li>
        <li class="browser-360"><a href="http://se.360.cn/" target="_blank"> 360安全浏览器 <span>360用户推荐</span></a></li>
        <!-- 2016-08-06 -->
        <li class="browser-firefox"><a href="http://www.firefox.com.cn/" target="_blank">
                火狐浏览器<span>Mozilla Firefox</span></a></li>
        <li class="browser-ie"><a href="http://windows.microsoft.com/zh-cn/internet-explorer/download-ie"
                                  target="_blank"> IE浏览器<span>Internet Explorer</span></a></li>
...
<script>function registertest() {
  ...
  $(document).ready(function () {
    ...
    $('.allGames').mouseover(function (e) {
      ...
      $(this).addClass('allGames-on').siblings('li').removeClass('allGames-on').find('.moreGames').css({
        'display': 'none'
      });
      $('#moreGames_' + tag).css({
        'display': 'block'
    ...
    $('.allGames').mouseout(function (e) {
      $(this).removeClass('allGames-on').find('.moreGames').css({
        'display': 'none'
      });
