    ...
    <div id="bet-game">
        ...
        <div class="game-btn">
            ...
            if ($groups) foreach ($groups as $key => $group) {
                ...
                <div class="ul-li<?= ($this->groupId == $group['id']) ? ' current' : '' ?>">
                    <a class="cai" href="/index.php/index/group/<?= $this->type . '/' . $group['id'] ?>"><span
        ...
        <div class="game-cont">
            ...
            <div class="num-table" style="height:auto;" id="game-dom">
                <div class="fandian">
                    <div class="fandian-k" style="display: none;">
                        <span class="spn8">奖金/返点：</span>
                        <div class="fandian-box" style="position: relative;">
                            <span id="fandian-value" class="fdmoney"
                                  style="position:absolute;bottom: 105%;right: 0;"><?= @$maxPl ?></span>
                            <div id='basic_slider' value="<?= $this->ifs($_COOKIE['fanDian'], 0) ?>"
                                 ...
                                 fan-dian="<?= $this->ifs($this->user['fanDian'], $fandian) ?>"
                                 game-fan-dian-bdw="<?= $this->settings['fanDianBdwMax'] ?>"
                                 fan-dian-bdw="<?= $this->user['fanDianBdw'] ?>" min="0" step="0.1">

                            </div>
                            <span id="fandian-value2" class="fdmoney2"
                                  style="position: absolute;bottom: 105%;left: -5px;margin-left: 0;">/0%</span>
                        </div>
                    ...
                    <div class="fl">
                        ...
                        <b value="0.020" data-max-fan-dian="<?= $this->settings['betModeMaxFanDian2'] ?>"
                           class="danwei">分</b><? } ?>
                        <?php if ($this->settings['limosi'] == 1) { ?>
                        <b value="0.002" data-max-fan-dian="<?= $this->settings['betModeMaxFanDian2'] ?>"
                           class="danwei">厘</b><? } ?>
                    </div>
                ...
                <div class="tz-tongji">
                    ...
                    <div class="hm">
                        <input type="checkbox" class="is_combine" value="1" id="cannel_chckbox"
                               style=" display: inline;  margin-top: 8px; width: 18px;height: 17px;float: left;margin-right: 2px;cursor: pointer;"/>
...
<div class="warp lotteryHistory" style="box-shadow: none;">
    ...
    <div class="line" style="margin-top: 20px;">
        ...
        <div class="getMore"><a class="sqlist" href="/index.php/record/search" title="查看更多投注记录" target="_blank">查看更多</a>
        </div>
    </div>
    <? } ?>
