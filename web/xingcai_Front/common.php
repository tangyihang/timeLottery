...
<head>
    ...
    <link href="/files/white_lobby_menu.css" rel="stylesheet"><!-- menu -->
    ...
    <meta name="viewport"
          content="width=device-width,height=device-height,initial-scale=1.0,maximum-scale=1,minimum-scale=1,user-scalable=yes">
        ...
        <div>
            ...
            <div id="live-main-list" class="live-main-list">
                ...
                <div id="hot_lottery" class="live-nav" style="top: 0px;">
                    ...
                    <ul>
                        ...
                        <li class="nav-li lot5" data-sort="2">
                            <a id="hot_main-item-5" class="nav-btn cur-btn" data-argsid="5" title="重庆时时彩"
                               onclick="__openWin('lottery_hall','/index.php/index/game/1/2/12/重庆时时彩')">
                                <i>
                                </i>
                                <span class="lot-text">重庆时时彩</span></a>
                        </li>
                        <li class="nav-li lot9" data-sort="3">
                            <a id="hot_main-item-9" class="nav-btn cur-btn" data-argsid="9" title="北京PK拾"
                               onclick="__openWin('lottery_hall','/index.php/index/game/20/27/北京PK拾')">
                                <i>
                                </i>
                ...
                <div id="high_lottery" class="live-nav" style="top: 0px;">
                    ...
                    <ul class="gao-ul">
                        ...
                        <li id="shishicai_ul">
                            ...
                            <ul hidden="">
                                <li class="nav-li lot51" data-sort="1">
                                    <a id="main-item-51" class="nav-btn cur-btn" data-argsid="51" title="三分时时彩"
                                       onclick="__openWin('lottery_hall','/index.php/index/game/86/2/12/三分时时彩')">
                                        <i>
                                        </i>
                                        <span class="lot-text">三分时时彩</span></a>
                                ...
                                <li class="nav-li lot5" data-sort="2">
                                    <a id="main-item-5" class="nav-btn cur-btn" data-argsid="5" title="重庆时时彩"
                                       onclick="__openWin('lottery_hall','/index.php/index/game/1/2/12/重庆时时彩')">
                                        <i>
                                        </i>
                                        <span class="lot-text">重庆时时彩</span></a>
                                ...
                                <li class="nav-li lot9" data-sort="3">
                                    <a id="main-item-9" class="nav-btn cur-btn" data-argsid="9" title="北京PK拾"
                                       onclick="__openWin('lottery_hall','/index.php/index/game/20/27/北京PK拾')">
                                        <i>
                                        </i>
                                        <span class="lot-text">北京PK拾</span></a>
                                ...
                                <li class="nav-li lot52" data-sort="5">
                                    <a id="main-item-52" class="nav-btn cur-btn" data-argsid="52" title="三分PK拾"
                                       onclick="__openWin('lottery_hall','/index.php/index/game/85/27/三分PK10')">
                                        <i>
                                        </i>
                                        <span class="lot-text">三分PK拾</span></a>
                        ...
                        <li id="pcdd_ul">
                            ...
                            <ul hidden="">
                                <li class="nav-li lot42" data-sort="4">
                                    <a id="main-item-42" class="nav-btn cur-btn" data-argsid="42" title="幸运28"
                                       onclick="__openWin('lottery_hall','/index.php/index/game/80/104/339/幸运28')">
                                        <i>
                                        </i>
                                        <span class="lot-text">幸运28</span></a>
                                ...
                                <li class="nav-li lot41" data-sort="100">
                                    <a id="main-item-41" class="nav-btn cur-btn" data-argsid="41" title="北京28"
                                       onclick="__openWin('lottery_hall','/index.php/index/game/83/104/339/北京28')">
                                        <i>
                                        </i>
                ...
                <div id="low_lottery" class="live-nav" style="top: 0px;">
                    ...
                    <ul class="gao-ul">
                        <li class="nav-li lot18" data-sort="6">
                            <a id="main-item-18" class="nav-btn cur-btn" data-argsid="18" title="香港⑥合彩"
                               onclick="__openWin('lottery_hall','/index.php/index/game/34/香港⑥合彩')">
                                <i>
                                </i>
                                <span class="lot-text">香港⑥合彩</span></a>
            ...
            <div id="_lottery_menu_head" class="new-header">
                <div name="hide">
                    ...
                    <div id="header_user" class="header-user">
                        ...
                        <div class="user-money">余额：<span id="balance">￥</span>
                            <div class="money-btn">
                                ...
                                <button class="withdraw" onclick="topay1();">提现</button>
                                <button class="withdraw" onclick="loginout();" style="display:none;">退出</button>
                            </div>
                        </div>
                        <div class="user-center">
                            <ul>
                                <li onclick="__openWin('user_center','/index.php/safe/tuiguang')"><a><i
                    ...
                    <div id="header_user_login">
                        <div class="lottery_login">
                            <div class="top-login-bg"><i class="icon-6"></i><input class="top_loginip" id="username"
                            ...
                            <div class="need_captcha">
                                ...
                                <div class="yanzhengma">
                                    <div class="top-login-bg2">
                                        <input class="top_loginmm" id="authnum" name="authnum" maxlength="4" type="text"
                                               placeholder="验证码">
                        ...
                        <div class="download">
                            <a class="icon-appleinc"
                               onclick="__openWin('home_phone',_static_const.download_Iphone)"></a>
                            <a class="icon-android"
                               onclick="__openWin('home_phone',_static_const.download_Android)"></a>
