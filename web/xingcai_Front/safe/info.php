            ...
            <form action="/index.php/safe/setCBAccount" method="post" target="ajax" onajax="safeBeforSetCBA"
                ...
                <table border="0" cellspacing="1" cellpadding="0" class="grayTable" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="account" class="text4"
                                   value="<?= preg_replace('/^(\w{4}).*(\w{4})$/', '\1***********\2', htmlspecialchars($myBank['account'])) ?>" <?= $this->iff($flag, 'readonly') ?>
                                   style="width:100px;"/>
                        </td>
                        <td>
                            <input type="text" name="username" class="text4"
                                   value="<?= $this->iff($myBank['username'], mb_substr(htmlspecialchars($myBank['username']), 0, 1, 'utf-8') . '**') ?>" <?= $this->iff($flag, 'readonly') ?> />
                        </td>
                        <td>
                            <input type="text" name="countname" class="text4"
