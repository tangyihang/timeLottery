            ...
            <div class="reg-info" id="_form_login">
                <ul>
                    <li>
                        ...
                        <div class="info-right"><input class="reg-int" type="text" id="username_login"
                                                       placeholder="请输入用户名"></div>
                        <div class="info-txt">请输入用户名（4-16个英文、数字）</div>
                    </li>
                    <li>
                        <div class="info-left"><span class="red">* </span>密码：</div>
                        <div class="info-right"><input class="reg-int" id="passwd_login" type="password"
                                                       placeholder="请输入密码"></div>
                        <div class="info-txt"></div>
                    </li>
                    <li>
                        <div class="info-left"><span class="red">* </span>验证码：</div>
                        <div class="info-right info-codes"><input id="vcode" class="codes-int" name="authnum"
                                                                  type="text" maxlength="4" placeholder="请输入验证码">
                            <div name="yzm_img_div" style="">
                                <div class="codes-img"><img class="validate" width="80" height="25" border="0"
                                                            id="dvcode" style="cursor:pointer;"
                                                            src="/index.php/user/vcode/1498379763" title="点击刷新"
                                                            onclick="this.src='/index.php/user/vcode/'+(new Date()).getTime()">
                                </div>
                                <a onclick="changeImg()" style="display:none;" class="text"><img src=""></a>
                                <!--<a onclick="changeImg()" class="orange" >看不清？换一个</a>-->
                            </div>
                    ...
                    <li>
                        ...
                        <div class="info-right"><input id="btn-sub" type="button" onclick="sb()" class="submit"
                                                       value="登录"></div>
                    </li>
                </ul>
            </div>
            ...
            <div class="reg-info" id="reg_form_1">
                <ul>
                    ...
                    <li>
                        <div class="info-left"><span class="red">* </span>密码：</div>
                        <div class="info-right">
                            <input name="passwd" id="passwd_reg" class="reg-int" type="password"
                                   maxlength="12">
                        </div>
                    ...
                    <li>
                        ...
                        <div class="info-right">
                            <input class="reg-int" maxlength="12" autocomplete="off" type="password"
                                   name="conpasswd" id="conpasswd"></div>
                    </li>
                    <li>
                        <div class="info-left"><span class="red">* </span>推荐码：</div>
                        <div class="info-right">
                            <input name="xcode" id="xcode_reg" class="reg-int" type="text"
                                   maxlength="12" value="<?=$_REQUEST['tj']?>"></div>
                    </li>
                    <li>
                        <div class="info-left"><span class="red">* </span>验证码：</div>
                        <div class="info-right info-codes" style="position:relative;">
                            <div class="top_click" name="div_top_click"></div>
                            <input name="verify" id="verify" class="codes-int " type="text" tabindex="4"
                                   autocomplete="off" maxlength="4"/>
                            <div id="need_captcha" class="reg_need_captcha">
                                <div class="yanzhengma">
                                    <span class="register_captcha_span" style="position:relative;">
                                       <img name="login_img" title="点击刷新" class="login_img"
                                            onclick="this.src='/index.php/user/vcode/'+(new Date()).getTime()">
                    ...
                    <li>
                        <div class="info-left">&nbsp;</div>
                        <div class="info-right">
                            <input type="checkbox" name="reg_checkbox" checked="checked"/>我已看过并同意
                            <a class="orange" target="_self" onClick="" width="1000" height="653" border="0">《喜羊羊彩网络服务协议》</a>
                        </div>
                    </li>
                    <li>
                        <div class="info-left">&nbsp;</div>
                        <div class="info-right"><input id="btn-sub" onclick="reg()" type="button" class="submit"
                                                       value="立即注册"></div>
                    </li>
                </ul>
            </div>
