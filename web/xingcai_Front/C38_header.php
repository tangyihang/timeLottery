        ...
        <div class="quick-tpis">
            ...
            <div class="header-right fr">
                ...
                <ul class="header-top-right fr ">
                    ...
                    <li id="wdtg"><a class="right-border" onClick="__openWin('user_center','/index.php/safe/tuiguang')"
            ...
            <div class="wrapper clearfix relative" style="width: 100%;">
                ...
                <div id="header_user" class="logxinxi" hidden="" style="display: block;">
                    <div class="top_login">
                        ...
                        <span>&nbsp;|&nbsp;
                                   <a onClick="__openWin('user_center','/index.php/box/receive')"
                                      href="javascript:void(0)">用户中心</a>&nbsp;|&nbsp;
                                    <a onClick="__openWin('user_center','/index.php/safe/c38_cz')"
                                       href="javascript:void(0)">充值</a>&nbsp;|&nbsp;
                                    <a onClick="topay();">提现</a>&nbsp;|&nbsp;
                                    <a onClick="__openWin('user_center','/index.php/record/search')"
                                       href="javascript:void(0)">交易记录</a>&nbsp;|&nbsp;
                        ...
                        <ul class="lottery-list-box" id="lottery-list-box">
                            ...
                            <li class="allGames clearfix" data-type="1">
                                ...
                                <ul class="clearfix game-list">
                                    ...
                                    <li>
                                        <a onClick="__openWin('lottery_hall','/index.php/index/game/87');">上海时时乐</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="moreGames-box fl">
                                        <div class="otherGames num-games">
                                            ...
                                            <ol>
                                                ...
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/60/2/12/天津时时彩');">天津时时彩</a>
                                                </li>
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/12/2/12/新疆时时彩');">新疆时时彩</a>
                                                </li>
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/79/39/江苏快三');">江苏快三</a>
                                                </li>
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/7/10/山东11选5');">山东11选5</a>
                                                </li>
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/15/10/上海11选5');">上海11选5</a>
                                                </li>
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/16/10/江西11选5');">江西11选5</a>
                                                </li>
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index.php/index/game/6/10/广东11选5');">广东11选5</a>
                                                </li>
                                                <li>
                                    ...
                                    <div class="moreGames-box fl">
                                        <div class="otherGames num-games">
                                            ...
                                            <ol>
                                                ...
                                                <li>
                                                    <a onClick="__openWin('lottery_hall','/index/game/10/排列3');">排列三</a>
                                                </li>
                                            </ol>
                                        </div>
                                    </div>
