...
$(window).bind("load",function(){
 setTimeout(function(){
 $("#user-data").tabulous({effect: "flip"});
 $("#showgd-box").tabulous({effect: "slideLeft"});
 },1000);
 });
 */
...
(function (e, c, a, g) {
    ...
    b.prototype = {
        init: function () {
            ...
            m.css({"position": "absolute", "top": "40px"});
          //  k.css("height", l + "px");
            i.addClass("tabulous_active");
            j.bind("click", {myOptions: this.options}, function (s) {
                s.preventDefault();
