            ...
            if ($data) {
                foreach ($data as $var) {
                    ...
                    for ($i = 0; $i < 10; $i++) //个位
                    {
                        ...
                        if ($five['M6' . $i] < $five['L6' . $i]) {
                            $five['M6' . $i] = $five['L6' . $i];
                        }
                        if ($five['MLC6' . $i] < $five['LC6' . $i]) {
                            $five['MLC6' . $i] = $five['LC6' . $i];
                        }
                    }
                    ...
                    for ($i = 0; $i < 10; $i++) //个位
                    {
                        ...
                        if ($five['M7' . $i] < $five['L7' . $i]) {
                            $five['M7' . $i] = $five['L7' . $i];
                        }
                        if ($five['MLC7' . $i] < $five['LC7' . $i]) {
                            $five['MLC7' . $i] = $five['LC7' . $i];
                        }
                    }
                    ...
                    for ($i = 0; $i < 10; $i++) //个位
                    {
                        ...
                        if ($five['M8' . $i] < $five['L8' . $i]) {
                            $five['M8' . $i] = $five['L8' . $i];
                        }
                        if ($five['MLC8' . $i] < $five['LC8' . $i]) {
                            $five['MLC8' . $i] = $five['LC8' . $i];
                        }
                    }
                    for ($i = 0; $i < 10; $i++) //个位
                    {
                        ...
                        if ($five['M9' . $i] < $five['L9' . $i]) {
                            $five['M9' . $i] = $five['L9' . $i];
                        }
                        if ($five['MLC9' . $i] < $five['LC9' . $i]) {
                            $five['MLC9' . $i] = $five['LC9' . $i];
                        }
                    }
                    for ($i = 0; $i < 10; $i++) //个位
                    {
                        ...
                        if ($five['Z10' . $i]) {
                            $five['Z10' . $i] += $five['L10' . $i];
                        } else {
                            $five['Z10' . $i] = $five['L10' . $i];
                        }
                        if ($five['M10' . $i] < $five['L10' . $i]) {
                            $five['M10' . $i] = $five['L10' . $i];
                        }
                        if ($five['MLC10' . $i] < $five['LC10' . $i]) {
                            $five['MLC10' . $i] = $five['LC10' . $i];
                        }
                    }
                    echo '</tr>';
