...
class xingcai extends WebBase{
	...
	public final function xcsfpk10(){
		$this->display('xingcai/sfpk10.php');
	}
	public final function xcsfssc(){
		$this->display('xingcai/sfssc.php');
	}
	
	public final function xy28(){
		$this->display('xingcai/xy28.php');
	}
